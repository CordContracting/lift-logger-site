// Vercel serverless function — receives a logged session from the app
// and writes it to Airtable using a secret token (set in Vercel env vars).
export default async function handler(req, res) {
  ...
  try {
    const { date, session, log, loggedAt } = req.body || {};
